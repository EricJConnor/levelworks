...
| 7 | Campaign PAUSED with budget, pixel, event | pass: campaign `52547713746537`, ad sets `52547713777737` (EN) / `52547713784537` (ES), six ads (recreated Sep 11 with the sharp cut, live from the moment of creation; the Sep 10 music-cut ads are deleted) `LW49-EN-estimate` `52548387667537` `LW49-EN-invoice` `52548387698137` `LW49-EN-recurring` `52548387719937` `LW49-ES-estimate` `52548387766737` `LW49-ES-invoice` `52548387793937` `LW49-ES-recurring` `52548387836137`, all PAUSED, in Meta review. 1:1 on feed, 9:16 on Stories/Reels via asset customization. **Dates are placeholders**: reset start/end to the go-live day before enabling. |
