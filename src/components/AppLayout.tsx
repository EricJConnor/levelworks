...
export const AppLayout: React.FC = () => {
  ...
  if (isAuthenticated === null || loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#eef4fb' }}>
      <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#3b82f6' }} />
    </div>
  );

  if (isAuthenticated === false) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#eef4fb', padding: '16px' }}>
