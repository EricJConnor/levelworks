...
export const estimates: Record<string, string> = {
  ...
  'inv.howTheyPay': 'How they can pay',
  'inv.payCard': 'Card',
  'inv.payBank': 'Bank',
  'inv.payBoth': 'Both',
  'inv.feeCard': 'Card fee on this invoice: about {fee}.',
  'inv.feeBank': 'Bank transfer fee on this invoice: {fee}. Takes about 4 business days.',
  'inv.feeBoth': 'Card about {card}, bank transfer {bank}. LevelWorks takes nothing either way.',
