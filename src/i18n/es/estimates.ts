...
export const estimates: Record<string, string> = {
  ...
  'inv.howTheyPay': 'Cómo pueden pagar',
  'inv.payCard': 'Tarjeta',
  'inv.payBank': 'Banco',
  'inv.payBoth': 'Ambos',
  'inv.feeCard': 'Comisión con tarjeta en esta factura: unos {fee}.',
  'inv.feeBank': 'Comisión por transferencia bancaria: {fee}. Tarda unos 4 días hábiles.',
  'inv.feeBoth': 'Tarjeta unos {card}, transferencia {bank}. LevelWorks no cobra nada en ninguno de los dos.',
