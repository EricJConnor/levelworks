...
export const landing: Record<string, string> = {
  ...
  // Español e inglés, mostrado arriba y en su propia sección (17 sep 2026)
  'lp.langChipAria': 'Funciona en español y en inglés. Leer más',
  'lp.heroFine4': 'Español e inglés',
  'lp.floatLang': 'Enviado en inglés',
  'lp.floatLangSub': 'Escrito en español, traducido con un toque',
  'lp.proof5': 'Español e inglés',
  'lp.proof5Sub': 'Todas las pantallas, y un botón para traducir lo que escribes.',
  'lp.tabLang': 'Español e inglés',
  'lp.tabLangBlurb': 'Cambia toda la app con un toque. Escribe el presupuesto en tu idioma, tradúcelo con un toque, revísalo lado a lado, y el cliente lo lee en el suyo.',
  'lp.langEyebrow': 'Español · English',
  'lp.langTitle': 'Funciona en español y en inglés. Tus presupuestos también.',
  'lp.langLead': '¿Tu cliente habla inglés? Mándale el presupuesto en inglés. Lo escribes como siempre, tocas Traducir, revisas las dos versiones lado a lado y lo envías. Todas las pantallas de la app cambian con un toque, así que tú y tu cliente cada uno lee en su idioma.',
  'lp.langCheck1': 'Toda la app en cualquiera de los dos idiomas, con un toque arriba de cualquier pantalla',
  'lp.langCheck2': 'Traduce lo que escribiste: partidas, notas, pies de foto',
  'lp.langCheck3': 'Revisas el original junto a la traducción antes de que salga nada',
  'lp.langCheck4': 'Los números, las medidas y las marcas nunca cambian',
  'lp.langNote': 'Tus palabras siguen siendo tuyas. La copia del cliente se hace a partir de ellas, y siempre puedes leer lo que escribiste.',
  'lp.langPhoneA': 'Lo que tú escribes',
  'lp.langPhoneB': 'Lo que recibe el cliente',
  'lp.trTitle': 'Traducir al inglés',
  'lp.trReview': 'Revisar',
  'lp.trOriginal': 'Tus palabras',
  'lp.trTranslation': 'La copia del cliente',
  'lp.trLocked': 'Los precios y las medidas están bloqueados',
  'lp.trCancel': 'Cancelar',
  'lp.trApply': 'Aplicar traducción',
};
