...
export const landing: Record<string, string> = {
  ...
  'an.h1': 'Un año de LevelWorks por $49.',
  'an.sub': 'Presupuestos, facturas y cobros recurrentes, en tu teléfono, en español o inglés. Un solo pago. Sin mensualidad durante un año.',
