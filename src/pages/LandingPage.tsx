      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 24px 60px' }}>
        <div style={{ maxWidth: '760px' }}>
          ...
          <p style={{ fontSize: '20px', color: '#a8a8a8', lineHeight: '1.6', marginBottom: '16px', maxWidth: '560px' }}>
            Professional UNLIMITED estimates, digital signatures, invoicing, client payments, <strong style={{ color: '#3b82f6' }}>automated recurring billing</strong>, your branded logo, job-site photo uploads, and client-ready before/during/after progress updates — everything for <strong style={{ color: '#fff' }}>$5 a month</strong>.
          </p>
